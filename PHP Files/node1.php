...
<html>
	...
	<body class="bg-info">
		...
		<div class="container">
            <?php
                $table = mysqli_query($connect, "SELECT temperature, humidity, pressure, rain, date, time FROM node_data WHERE node = 1 ORDER BY id DESC LIMIT 1");
                $row = mysqli_fetch_array($table);
				echo "<h1>Data at Node 1</h1>";
